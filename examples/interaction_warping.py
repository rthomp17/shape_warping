...
utils.trimesh_transform(
    test_child_mesh, rotation=utils.euler_to_matrix([np.pi / 2, 0, 0])
)
...
test_pcds = {
    "parent": utils.scale_points_circle([test_pcds["parent"]], base_scale=0.2)[0],
    "child": utils.scale_points_circle([test_pcds["child"]], base_scale=0.2)[0],
}
...
for object_type in ("parent", "child"):
    ...
    print(f"Fitting the demo {object_type} object shape and pose")
    reconstructed_test_pcds[object_type], _, reconstructed_test_params[object_type] = (
        warp_to_pcd_se2(
            warp_reconstruction,
            n_angles=5,
            n_batches=1,
...
test_interaction_points = warp_interaction_points(
    interaction_points,
    warp_models["child"],
    warp_models["parent"],
...
test_transferred_points_fig = viz_utils.show_pcds_plotly(
    {
        "Test Parent Object": test_pcds["parent"],
        "Test Child Object": test_pcds["child"],
        "Test Parent Object Reconstruction": reconstructed_test_pcds["parent"],

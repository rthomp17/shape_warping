...
canon_adjacent_parts = [
    {"body": part_warp_models["body"], "handle": part_warp_models["handle"]},
    {"body": part_warp_models["body"], "spout": part_warp_models["spout"]},
    {"body": part_warp_models["body"], "lid": part_warp_models["lid"]},
    {"lid": part_warp_models["lid"], "handle": part_warp_models["handle"]},
    {"lid": part_warp_models["lid"], "spout": part_warp_models["spout"]},
]


test_object_adjacent_parts = [
    {"body": test_object_pcls["body"], "handle": test_object_pcls["handle"]},
    {"body": test_object_pcls["body"], "spout": test_object_pcls["spout"]},
    {"body": test_object_pcls["body"], "lid": test_object_pcls["lid"]},
    {"lid": test_object_pcls["lid"], "handle": test_object_pcls["handle"]},
    {"lid": test_object_pcls["lid"], "spout": test_object_pcls["spout"]},
]
...
viz_utils.visualize_teapot_relational_descriptors(
    canon_adjacent_parts,
    {part: part_warp_models[part].canonical_pcl for part in object_parts},
    canon_part_labels,
    title="Canon Relational Descriptors",
)
...
viz_utils.visualize_teapot_relational_descriptors(
    test_object_adjacent_parts,
    test_object_pcls,
    test_object_part_labels,
    title="Test Object Relational Descriptors",
)
